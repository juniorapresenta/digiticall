...
// DigiTICall restored JS - robust handlers
document.addEventListener('DOMContentLoaded', function() {
  ...
  document.querySelectorAll('[data-action]').forEach(function(el){
    ...
    el.addEventListener('click', function(e){
      e.preventDefault();
      if(a === 'scrollToContact') window.scrollToContact();
      else if(a === 'scrollToServices') window.scrollToServices();
      else if(a === 'openWhatsApp') window.openWhatsApp();
      else if(a === 'openServiceModal') {
  ...
  window.openWhatsApp = function(){
    ...
    const text = encodeURIComponent('Olá, gostaria de uma consultoria.');
